...
<html lang="zh-CN">
    ...
    <body>
        ...
        $userLove = 0;
        $love = count($activity['loves']['ips']) + count($activity['loves']['uids']);
        if (in_array($uid, $activity['loves']['uids']) || in_array(getIp(), $activity['loves']['ips'])) {
            $userLove = 1;
        }
        ...
        <div class="page-wrapper activity">
            <?php
            if ($info['activity']['pass'] == 0 && ($user['id'] == $info['activity']['publisher']['uid'] || $easyteeAdmin)) {
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="activity-share clearfix">
                                    ...
                                    <div class="pull-right"><a href="javascript:void(0)" title="喜欢"><span class="iconfont icon-love" style="<?php echo ($userLove) ? "color:#F72602;" : ''; ?>"></span> <em><?php echo (($userLove) ? "已喜欢" : "喜欢") . "($love)"; ?></em></a></div>
                            ...
                            <div class="col-xs-12 activity-detail-nav">
                                <ul class="nav nav-tabs nav-justified" role="tablist">
                                    ...
                                    <li role="presentation"><a href="#supporter" role="tab" data-toggle="tab">支持者 <span
                                                class="badge"><?php echo $activity['SupporterCount']; ?></span></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-default hidden-xs">
                            ...
                            <div class="panel-body">
                                <?php
                                if (is_array($activity['newSupporter'])) {
                                    foreach ($activity['newSupporter'] as $userkey => $supporter) {
                                        ?>
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="#">
                                                    <img class="media-object" src="<?php echo $supporter['image']; ?>"
                                                         style="width:40px;height: 40px;">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <h4 class="media-heading"><?php echo ($supporter['userName']) ? $supporter['userName'] : $supporter['mobile']; ?>
                                                    <span
                                                        class="pull-right"><?php echo $supporter['quantity']; ?>件</span></h4>
        <?php echo $supporter['time']; ?>
                                            </div>
                                        </div>
                        ...
                        <?php
                        if (is_array($activity['newSupporter'])) {
                            foreach ($activity['newFourm'] as $key => $comment) {
                                if ($key > 5) {
                                    break;
                                }
                                ?>
                                                                                                                        <div class="media">
                                                                                                                            <div class="media-left">
                                                                                                                                <a href="#">
                                                                                                                                    <img class="media-object" src="<?php echo $comment['image']; ?>">
                                                                                                                                </a>
                                                                                                                            </div>
                                                                                                                            <div class="media-body">
                                                                                                                                <h4 class="media-heading"><?php echo $comment['userName']; ?><span
                                                                                                                                        class="pull-right"><?php echo $comment['postTime']; ?></span></h4>
...
<?php echo $this->element('site-footer'); ?>
        <script>
            var activity = {
                ...
                design: <?php echo json_encode($activity['design']); ?>,
