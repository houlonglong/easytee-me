...
//                    printXmlDocument(xmlDoc);
    ...
    this.getInitialLoad = function(c, e, d, g, k) {
        ...
        $.ajax({
            type: "POST",
            xhrFields: r,
            url: m.adjustUrl("/api?model=design/tool/beta&action=init&&product_id=" + c),
            success: function(e) {
//                debugger;
...
//            parameters: [b, 0, 0, 0, e ? e : "", c],
    ...
    this.loadFont = function(font, callback, text, errCallback, callback2) {
        ...
        var src = "//" + b.domain + "/api?model=design/tool/beta&action=font_get_js_font&font_id=" + fontId + "&text=" + encodeURIComponent(text);
