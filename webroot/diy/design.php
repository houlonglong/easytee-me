...
<head>
    ...
    define('EASYTEE_API'   ,'http://'.$_SERVER['HTTP_HOST'].'/');
    $userToken = 0;
    $designId = "4311";
    $appProductId = "11";
    $appProductStyleId = "107";
    ?>
</head>
<body>
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown  pull-right">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">18601628937 <span class="caret"></span></a>
    ...
    <div class="row">
        <div class="col-12" id="designerParentContainer" style="margin: 70px auto 20px auto;height: 731px;">
            <script type="text/javascript" language="javascript"
                    src="/diy/html5/ds/js/launcher.js"></script>
            <script type="text/javascript" language="javascript">

                //window.console.debug = window.console.log = window.console.info = function() {}
                ...
                var flashvars =
                {
                    ActivityID:4311,
                    //"EmbedType":"iframe",
                    "DesignerLocation": "<?php echo EASYTEE_API;?>diy/html5",
...
<div class="hide">
    <svg width='500' height='500' id='svg_tmp1'></svg>
</div>
<script class="reload" src="/js/app/convert.js"></script>
