/*! ETDS 2015-09-25 */
function BitmapPalettes(a, b, c, d) {
    function e(a, b) {
    ...
    function f() {
        this.rgbToXyz = function (a) {
            var b = a[0] / 255, c = a[1] / 255;
            return a = a[2] / 255, b = b > .04045 ? Math.pow((b + .055) / 1.055, 2.4) : b / 12.92, c = c > .04045 ? Math.pow((c + .055) / 1.055, 2.4) : c / 12.92, a = a > .04045 ? Math.pow((a + .055) / 1.055, 2.4) : a / 12.92, b *= 100, c *= 100, a *= 100, [.4124 * b + .3576 * c + .1805 * a, .2126 * b + .7152 * c + .0722 * a, .0193 * b + .1192 * c + .9505 * a]
        }, this.xyzToLab = function (a) {
            var b = a[0] / 95.047, c = a[1] / 100;
            return a = a[2] / 108.883, b = b > .008856 ? Math.pow(b, 1 / 3) : 7.787 * b + 16 / 116, c = c > .008856 ? Math.pow(c, 1 / 3) : 7.787 * c + 16 / 116, a = a > .008856 ? Math.pow(a, 1 / 3) : 7.787 * a + 16 / 116, [116 * c - 16, 500 * (b - c), 200 * (c - a)]
        }, this.labToXyz = function (a) {
            var b = (a[0] + 16) / 116, c = a[1] / 500 + b;
            a = b - a[2] / 200;
            var d = Math.pow(b, 3), e = Math.pow(c, 3), f = Math.pow(a, 3);
            return[95.047 * (e > .008856 ? e : (c - 16 / 116) / 7.787), 100 * (d > .008856 ? d : (b - 16 / 116) / 7.787), 108.883 * (f > .008856 ? f : (a - 16 / 116) / 7.787)]
        }, this.xyzToRgb = function (a) {
            var b = a[0] / 100, c = a[1] / 100, d = a[2] / 100;
            a = 3.2406 * b + -1.5372 * c + -.4986 * d;
            var e = -.9689 * b + 1.8758 * c + .0415 * d, b = .0557 * b + -.204 * c + 1.057 * d;
            return a = a > .0031308 ? 1.055 * Math.pow(a, 1 / 2.4) - .055 : 12.92 * a, e = e > .0031308 ? 1.055 * Math.pow(e, 1 / 2.4) - .055 : 12.92 * e, b = b > .0031308 ? 1.055 * Math.pow(b, 1 / 2.4) - .055 : 12.92 * b, [Math.round(255 * a), Math.round(255 * e), Math.round(255 * b)]
        }, this.labToRgb = function (a) {
            return a = this.labToXyz(a), this.xyzToRgb(a)
        }, this.rgbToLab = function (a) {
            return a = this.rgbToXyz(a), this.xyzToLab(a)
        }, this.ciede2000 = function (a, b) {
            var c = Math.sqrt, d = Math.pow, e = Math.cos, f = Math.atan2, g = Math.sin, h = Math.abs, i = Math.exp, j = Math.PI, k = a[0], l = a[1], m = a[2], n = b[0], o = b[1], p = b[2], q = c(d(l, 2) + d(m, 2)), r = c(d(o, 2) + d(p, 2)), s = (q + r) / 2, s = .5 * (1 - c(d(s, 7) / (d(s, 7) + d(25, 7)))), l = (1 + s) * l, t = (1 + s) * o, o = c(d(l, 2) + d(m, 2)), s = c(d(t, 2) + d(p, 2)), u = function (a, b) {
                if (0 === a && 0 === b)return 0;
                var c;
                return c = f(a, b) * (180 / j), c >= 0 ? c : c + 360
            }, v = u(m, l), t = u(p, t), p = n - k, m = s - o, l = function (a, b, c, d) {
                if (0 === a * b)return 0;
                if (180 >= h(d - c))return d - c;
                if (d - c > 180)return d - c - 360;
                if (-180 > d - c)return d - c + 360;
                throw Error()
            }(q, r, v, t), l = 2 * c(o * s) * g(j / 180 * l / 2), k = (k + n) / 2, n = (o + s) / 2, q = function (a, b, c, d) {
                if (0 === a * b)return c + d;
                if (180 >= h(c - d))return(c + d) / 2;
                if (180 < h(c - d) && 360 > c + d)return(c + d + 360) / 2;
                if (180 < h(c - d) && c + d >= 360)return(c + d - 360) / 2;
                throw Error()
            }(q, r, v, t), e = 1 - .17 * e(j / 180 * (q - 30)) + .24 * e(j / 180 * q * 2) + .32 * e(j / 180 * (3 * q + 6)) - .2 * e(j / 180 * (4 * q - 63)), i = 30 * i(-d((q - 275) / 25, 2)), q = c(d(n, 7) / (d(n, 7) + d(25, 7))), r = 1 + .015 * d(k - 50, 2) / c(20 + d(k - 50, 2)), k = 1 + .045 * n, e = 1 + .015 * n * e, g = -2 * q * g(j / 180 * i * 2);
            return c(d(p / (1 * r), 2) + d(m / (1 * k), 2) + d(l / (1 * e), 2) + m / (1 * k) * g * (l / (1 * e)))
        }
    }
    ...
    function g(a) {
        function b(a, b) {
            var c, d, e, f, g, h;
            switch (Object.prototype.toString.call(a).slice(8, -1)) {
                case"HTMLImageElement":
                    c = document.createElement("canvas"), c.width = a.naturalWidth, c.height = a.naturalHeight, d = c.getContext("2d"), d.drawImage(a, 0, 0);
                case"HTMLCanvasElement":
                    c = c || a, d = d || c.getContext("2d");
                case"CanvasRenderingContext2D":
                    d = d || a, c = c || d.canvas, e = d.getImageData(0, 0, c.width, c.height);
                case"ImageData":
                    e = e || a, b = e.width, f = "CanvasPixelArray" === Object.prototype.toString.call(e.data).slice(8, -1) ? new Uint8Array(e.data) : e.data;
                case"Array":
                    f = f || new Uint8Array(a);
                case"Uint8Array":
                case"Uint8ClampedArray":
                    f = f || a, g = new Uint32Array(f.buffer);
                case"Uint32Array":
                    g = g || a, f = f || new Uint8Array(g.buffer), b = b || g.length, h = g.length / b
            }
            return{can: c, ctx: d, imgd: e, buf8: f, buf32: g, width: b, height: h}
        }

        var c = k.ciede2000;
        this.getPalette = function (d) {
            c = k.ciede2000;
            var e = document.createElement("canvas");
            e.width = 128, e.height = a.naturalHeight * e.width / a.naturalWidth, e.getContext("2d").drawImage(a, 0, 0, e.width, e.height);
            for (var e = b(e).buf32, f = e.length, g = {colors: []}, h = 0; f > h; h++) {
                var i = e[h], i = [255 & i, (65280 & i) >> 8, (16711680 & i) >> 16, (4278190080 & i) >> 24];
                if (0 !== i[3]) {
                    if (0 == i[0] && 0 == i[1]);
                    var i = k.rgbToLab(i), j = this.getNearest(g.colors, i), l = null;
                    j.difference > d ? (l = {colors: [i]}, this.getRepresentativeColor(l), g.colors.push(l)) : (l = g.colors[j.index], l.colors.push(i), this.getRepresentativeColor(l))
                }
            }
            return g
        }, this.getRepresentativeColor = function (a) {
            var b = a.colors[a.colors.length - 1];
            a.labInfo || (a.labInfo = {}, a.lab = b), a.labInfo[b] || (a.labInfo[b] = 0), a.labInfo[b]++, a.labInfo[b] > a.labInfo[a.lab] && (a.lab = b)
        }, this.reducePaletteForced = function (a, b) {
            b = b || 50, a.colors.sort(function (a, b) {
                return b.colors.length - a.colors.length
            });
            for (var c = 0, d = a.colors.slice(0), e = 0; e < d.length; e++)c += d[e].colors.length;
            for (; d.length > b;) {
                for (var f = [], e = 0; e < d.length; e++) {
                    var g = d[e], h = g.colors.length / c;
                    g = this.getNearest(d, g.lab, e), f[e] = {index: e, closest: g, value: h * g.difference}
                }
                f.sort(function (a, b) {
                    return a.value - b.value
                }), e = f[0], this.mergePaletteColors(e.closest.value, d[e.index]), d.splice(e.index, 1)
            }
            for (var i = [], k = 0; k < a.colors.length; k++)d[k] && d[k].colors.length / c > j && i.push(d[k]);
            return i
        }, this.mergePaletteColors = function (a, b) {
            for (var c = 0; c < b.colors.length; c++)a.colors.push(b.colors[c]), this.getRepresentativeColor(a)
        }, this.reduceToPalette = function (c) {
            var d = document.createElement("canvas");
            d.width = a.naturalWidth, d.height = a.naturalHeight;
            var e = d.width / 10, f = d.height / 10, g = d.getContext("2d");
            g.drawImage(a, 0, 0, e, f), g.imageSmoothingEnabled = g.mozImageSmoothingEnabled = g.webkitImageSmoothingEnabled = !1;
            for (var h = g.getImageData(0, 0, e, f), i = b(d).buf32, j = new ArrayBuffer(h.data.length), l = new Uint8ClampedArray(j), j = new Uint32Array(j), m = {}, n = 0; f > n; ++n)for (var o = 0; e > o; ++o) {
                var p = n * e + o, q = i[p];
                if (m[q])j[p] = m[q]; else {
                    var r = (4278190080 & q) >> 24, s = k.rgbToXyz([255 & q, (65280 & q) >> 8, (16711680 & q) >> 16]), s = k.xyzToLab(s), s = this.getNearest(c, s).value.lab, s = k.labToXyz(s), s = k.xyzToRgb(s), r = r << 24 | s[2] << 16 | s[1] << 8 | s[0];
                    m[q] = r, j[p] = r
                }
            }
            return h.data.set(l), g.putImageData(h, 0, 0), d
        }, this.getNearest = function (a, b, d) {
            for (var e = 1e5, f = -1, g = null, h = 0; h < a.length; h++)if (h !== d) {
                var i = c(a[h].lab, b);
                if (e > i && (e = i, f = h, g = a[h]), 0 === i)break
            }
            return{difference: e, index: f, value: g}
        }
    }

    function h(a) {
        function b(a) {
            if ("HTMLCanvasElement" === h.toString().slice(8, -1)) {
                var b = !1, c = new Image;
                c.onload = function () {
                    a && !b && (a(), b = !0)
                }, c.src = h.toDataURL(), c.naturalWidth && a && !b && (setTimeout(a), b = !0), h = c
            }
        }

        function c(a) {
            for (var b = [], c = 0; c < a.length; c++) {
                var d = k.labToRgb(a[c].lab);
                b.push(d)
            }
            return b
        }
        ...
        function f(a) {
            for (var b = [], c = 0; c < a.length; c++) {
                var e = d(a[c][0].toString(16)), e = e + d(a[c][1].toString(16)), e = e + d(a[c][2].toString(16)), e = a[c][3] ? e + d(a[c][3].toString(16)) : e + "ff";
                b.push(e)
            }
            return b
        }
        ...
        var h = a, i = [];
        this.getQuantizedImage = function (a) {
            a = parseInt(a);
            var b = e(i, function (b) {
                return b.colors.length == a
            });
            if (b)return b;
            var b = new g(h), d = b.getPalette(9), d = b.reducePaletteForced(d, a), b = b.reduceToPalette(d), d = c(d);
            return b.id = "canvas_bmp" + a, b = {img: b, colors: f(d), oColors: f(d)}, i.push(b), b
        }, b()
    }
    ...
    function i(a, b) {
        ...
        e.crossOrigin = "Anonymous", e.onload = function () {
            c.height = e.height, c.width = e.width, d.drawImage(e, 0, 0);
            var a = c.toDataURL("image/png");
            b.call(this, a), c = null
        }, e.src = a
    }
    ...
    i(a, function (a) {
        var b = new Image;
        b.src = a;
        var e = new h(b), f = e.getQuantizedImage(c), g = [];
        for (var i in f.colors) {
            var j = f.colors[i];
            g.push(j.substr(0, 6))
        }
        d(g)
...
function EventManager() {
    this.element = $(window), this.trigger = function (a, b) {
        this.element.trigger(a, [b])
    }, this.on = function (a, b) {
        var c = function (a, c) {
            b(c)
        };
        return this.element.on(a, c), function () {
            eventManager.element.off(a, c)
        }
    }
}
function cmConvertToPx(a, b) {
    return a * b
}
function pxConvertToCm(a, b) {
    return a / b
}
...
function calcDistanceBetweenTwoPoints(a, b) {
    var c = b.x - a.x, d = b.y - a.y;
    return Math.pow(c * c + d * d, .5)
}
function drawBox(a, b, c, d) {
}
function calcElementWrapBox(a, b) {
    var c, d, e, f, a = $(a), g = a.offset().left, h = a.offset().top, i = a.outerHeight(), j = a.outerWidth();
    if (b && 45 != b) {
        var k, l;
        Math.abs(b) >= 0 && Math.abs(b) < 90 ? (b = Math.abs(b), k = i * Math.sin(Math.PI / 180 * b) + j * Math.cos(Math.PI / 180 * b), l = i * Math.cos(Math.PI / 180 * b) + j * Math.sin(Math.PI / 180 * b)) : b >= 90 && 180 > b ? (b -= 90, k = i * Math.cos(Math.PI / 180 * b) + j * Math.sin(Math.PI / 180 * b), l = i * Math.sin(Math.PI / 180 * b) + j * Math.cos(Math.PI / 180 * b)) : b >= 180 && 270 > b ? (b -= 180, k = i * Math.sin(Math.PI / 180 * b) + j * Math.cos(Math.PI / 180 * b), l = i * Math.cos(Math.PI / 180 * b) + j * Math.sin(Math.PI / 180 * b)) : b >= 270 && 305 > b && (b -= 270, k = i * Math.cos(Math.PI / 180 * b) + j * Math.sin(Math.PI / 180 * b), l = i * Math.sin(Math.PI / 180 * b) + j * Math.cos(Math.PI / 180 * b)), drawBox(g, h, k, l), c = g, d = h, e = k, f = l
    } else drawBox(g, h, j, i), c = g, d = h, e = j, f = i;
    return{x: c, y: d, w: e, h: f}
}
function ElementEl(a, b, c, d, e, f, g, h, i, j) {
    var k = this;
    this.svgSurface = $(a.svgSurface), this.htmlSurface = $(a.htmlSurface), this.printable = $(a.printable), this.x = b, this.y = c, this.translateX = d || 0, this.translateY = e || 0, this.angle = f || 0, this.scaleX = g || 1, this.scaleY = h || 1, this.flipX = i || 1, this.flipY = j || 1, this.box = null, this.transform = function () {
        var a = this.matrix.clone();
        this.g.transform(a.translate(this.translateX, this.translateY)), this.g.transform(a.rotate(this.angle, this.originX, this.originY)), this.g.transform(a.scale(this.scaleX, this.scaleY, this.originX, this.originY)), this.g.transform(a.rotate(this.flipX * this.angle, this.originX, this.originY)), this.g.transform(a.scale(this.flipX, 1, this.originX, this.originY)), this.flipX > 0 ? this.g.transform(a.rotate(this.flipX * this.angle * -1, this.originX, this.originY)) : this.g.transform(a.rotate(this.flipX * this.angle * 1, this.originX, this.originY)), this.g.transform(a.rotate(this.flipY * this.angle, this.originX, this.originY)), this.g.transform(a.scale(1, this.flipY, this.originX, this.originY)), this.flipY > 0 ? this.g.transform(a.rotate(this.flipY * this.angle * -1, this.originX, this.originY)) : this.g.transform(a.rotate(this.flipY * this.angle * 1, this.originX, this.originY))
    }, this.initBox = function (b) {
        this.box && this.box.remove() && (this.box = null), b || (this.width = this.snapEl.getBBox().width, this.height = this.snapEl.getBBox().height), this.originX = this.x + this.width / 2, this.originY = this.y + this.height / 2, this.box = new ElementBox(a, this, this.width, this.height, this.translateX, this.translateY, this.angle, this.scaleX, this.scaleY);
        var c = this.box.getOriginMatrix();
        this.matrix = new Snap.Matrix, this.matrix.add(c.a, c.b, c.c, c.d, c.e, c.f), this.transform(), a.checkPrintableAlarm(), this.box.onTransform(function () {
            var a = arguments[0];
            switch (a) {
                case"translate":
                    k.translateX += arguments[1], k.translateY += arguments[2];
                    break;
                case"rotate":
                    k.angle = parseFloat(arguments[1].toFixed(6));
                    break;
                case"scale":
                    k.scaleX = arguments[1], k.scaleY = arguments[2];
                    break;
                case"horizontal":
                    k.scaleX = arguments[1];
                    break;
                case"vertical":
                    k.scaleY = arguments[1]
            }
            k.transform()
        })
    }, this.onFlipX = function () {
        this.flipX *= -1, this.transform()
    }, this.onFlipY = function () {
        this.flipY *= -1, this.transform()
    }, this.alignToCenter = function () {
        this.translateX = 0, this.translateY = 0, this.initBox()
    }, this.remove = function () {
        this.g.remove(), a.checkPrintableAlarm()
    }, eventManager.on("deletedBox", function (a) {
        a == k && k.remove()
    })
}
function TextElementEl(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
    this.type = "text", this.canvas = a, this.string = b, this.lineHeight = c, this.fontFamily = d, this.fontSize = e, this.fill = f, this.stroke = g, this.strokeWidth = h, this.g = this.canvas.paper.g(), this.dataId = "g-" + (new Date).getTime(), this.g.attr("data-id", this.dataId), this.canvas.rootG.add(this.g), this.snapEl = this.canvas.paper.text(0, 0, this.string), this.snapEl.node.setAttribute("font-size", this.fontSize), this.snapEl.node.setAttribute("font-family", this.fontFamily), this.snapEl.node.setAttribute("fill", this.fill), this.snapEl.node.setAttribute("stroke", this.stroke), this.snapEl.node.setAttribute("stroke-width", this.strokeWidth);
    for (var p = 0; p < this.snapEl.node.childNodes.length; p++) {
        var q = this.snapEl.node.childNodes[p];
        q.setAttribute("x", 0), q.setAttribute("y", 0), q.setAttribute("dy", this.fontSize + p * this.fontSize)
    }
    for (var r = this.snapEl.node.getBBox(), p = 0; p < this.snapEl.node.childNodes.length; p++) {
        var q = this.snapEl.node.childNodes[p], s = parseInt(q.getAttribute("dy"));
        s -= r.y, q.setAttribute("dy", s)
    }
    this.g.add(this.snapEl), ElementEl.call(this, a, 0, 0, i, j, k, l, m, n, o), this.initBox()
}
function BitmapElementEl(a, b, c, d, e, f, g, h, i) {
    var j = this;
    this.type = "bitmap", this.url = b, this.colors = [];
    var k = function () {
    };
    this.onload = function (a) {
        k = a
    }, this.init = function () {
        this.g = a.paper.g(), this.dataId = "g-" + (new Date).getTime(), this.g.attr("data-id", this.dataId), a.rootG.add(this.g), this.snapEl = this.snapEl = a.paper.image(this.url, 0, 0, a.opt.printable.width, a.opt.printable.height), this.g.add(this.snapEl), ElementEl.call(this, a, 0, 0, c, d, e, f, g, h, i), this.initBox(), k()
    }, new BitmapPalettes(b, .012, null, function (a) {
        this.colors = a, a.length <= 10 ? j.init() : eventManager.trigger("tooManyColors", a)
    })
}
function Transform(a, b, c, d, e, f) {
    function g() {
        return{x: getMatrix(b, "x") + b.outerWidth() / 2, y: getMatrix(b, "y") + b.outerHeight() / 2}
    }

    function h() {
        var a = F.origin, c = {x: F.origin.x + b.width(), y: F.origin.y - b.height()};
        return Math.abs(calcAngle(a, c))
    }

    function i() {
        F.origin = g(), F.deltaAngle = h()
    }

    function j(d) {
        if (n) {
            var e = calcDistanceBetweenTwoPoints({x: F.origin.x + c.offset().left, y: F.origin.y + c.offset().top}, {x: d.pageX, y: d.pageY}), f = e / A, g = z * f, h = (g - z) / 2, j = x - h;
            setMatrix(b, null, null, null, j), b.css({height: g}), M("vertical", g / E), a.checkPrintableAlarm()
        }
        if (o) {
            var e = calcDistanceBetweenTwoPoints({x: F.origin.x + c.offset().left, y: F.origin.y + c.offset().top}, {x: d.pageX, y: d.pageY}), f = e / A, k = y * f, l = (k - y) / 2, u = w - l;
            setMatrix(b, null, null, u, null), b.css({width: k}), M("horizontal", k / D), a.checkPrintableAlarm()
        }
        if (p) {
            var v = d.pageX - s, B = d.pageY - t, u = getMatrix(b, "x") + v, j = getMatrix(b, "y") + B;
            if (a.isAutoAlign) {
                var C = u + b.outerWidth() / 2, N = G - C;
                Math.abs(N) < 8 ? I || (I = !0, J = N, u = G - b.outerWidth() / 2, v += N, setMatrix(b, null, null, u, 0), i(), M("translate", v, 0)) : (I = !1, setMatrix(b, null, null, u - J, 0), i(), M("translate", v - J, 0), s = d.pageX, J = 0);
                var O = j + b.outerHeight() / 2, P = H - O;
                Math.abs(P) < 8 ? K || (K = !0, L = P, j = H - b.outerHeight() / 2, B += P, setMatrix(b, null, null, 0, j), i(), M("translate", 0, B)) : (K = !1, setMatrix(b, null, null, 0, j - L), i(), M("translate", 0, B - L), t = d.pageY, L = 0)
            } else I = !1, J = 0, K = !1, L = 0, setMatrix(b, null, null, u, j), i(), M("translate", v, B), s = d.pageX, t = d.pageY;
            a.checkPrintableAlarm()
        }
        if (q) {
            var Q = calcAngle({x: F.origin.x + c.offset().left, y: F.origin.y + c.offset().top}, {x: d.pageX, y: d.pageY});
            d.pageX < F.origin.x + c.offset().left && (Q += 180), F.angle = Q + F.deltaAngle;
            var R = Math.cos(F.angle * Math.PI / 180).toFixed(4), S = Math.sin(F.angle * Math.PI / 180).toFixed(4);
            setMatrix(b, R, S, null, null), M("rotate", F.angle), a.checkPrintableAlarm()
        }
        if (r) {
            var e = calcDistanceBetweenTwoPoints({x: F.origin.x + c.offset().left, y: F.origin.y + c.offset().top}, {x: d.pageX, y: d.pageY}), f = e / A, T = y * f, U = z * f, l = (T - y) / 2, h = (U - z) / 2, u = w - l, j = x - h;
            setMatrix(b, null, null, u, j), b.css({width: T, height: U}), M("scale", T / D, U / E), a.checkPrintableAlarm()
        }
        m()
    }
    ...
    function k() {
        var d, e;
        "sizer_w" == $(this).attr("id") ? d = $(this).val() : e = $(this).val();
        var f = b.outerWidth(), g = b.outerHeight(), h = f / g, i = getMatrix(b, "x"), j = getMatrix(b, "y");
        if (d && !isNaN(d)) {
            d > 30 && (d = 30), d = parseFloat(d).toFixed(2), $("#sizer_w").val(d);
            var k = cmConvertToPx(parseFloat(d), a.opt.scale), l = k / h;
            $("#sizer_h").val(pxConvertToCm(l, a.opt.scale).toFixed(2));
            var m = (k - f) / 2, n = (l - g) / 2, o = i - m, p = j - n;
            setMatrix(b, null, null, o, p), b.css({width: k, height: l}), M("scale", k / D, l / E)
        } else if (e && !isNaN(e)) {
            e > 30 && (e = 30), e = parseFloat(e).toFixed(2), $("#sizer_h").val(e);
            var l = cmConvertToPx(parseFloat(e), a.opt.scale), k = l * h;
            $("#sizer_w").val(pxConvertToCm(k, a.opt.scale).toFixed(2));
            var m = (k - f) / 2, n = (l - g) / 2, o = i - m, p = j - n;
            setMatrix(b, null, null, o, p), b.css({width: k, height: l}), M("scale", k / D, l / E)
        }
        a.checkPrintableAlarm();
        var q = calcElementWrapBox(b, F.angle);
        $(".edit-box-sizer").css({left: q.x + q.w / 2 - B.outerWidth() / 2 - c.offset().left, top: q.y + q.h + 35 - c.offset().top, zIndex: 100})
    }
    ...
    function l(a) {
        ...
        if (!d.hasClass("edit")) {
            var e = d.find("span:eq(0)").text(), f = d.find("span:eq(1)").text();
            d.addClass("edit"), d.empty();
            var g = "";
            g += '<span>宽</span><input id="sizer_w" type="text" value="' + e + '"><i>cm</i>', g += '<span>高</span><input id="sizer_h" type="text" value="' + f + '"><i>cm</i>', d.append(g), d.find("input").bind("input", k);
            var h = calcElementWrapBox(b, F.angle);
            d.css({left: h.x + h.w / 2 - d.outerWidth() / 2 - c.offset().left, top: h.y + h.h + 35 - c.offset().top, zIndex: 100})
        }
    }

    function m() {
        $("div.edit-box-sizer").remove();
        var d = pxConvertToCm(b.width(), a.opt.scale).toFixed(2), e = pxConvertToCm(b.height(), a.opt.scale).toFixed(2);
        B = C.sizer = $('<div class="edit-box-sizer"><span>' + d + "</span><i>cm</i> <i>x</i> <span>" + e + "</span><i>cm</i></span></div>"), c.append(B);
        var f = calcElementWrapBox(b, F.angle);
        B.css({left: f.x + f.w / 2 - B.width() / 2 - c.offset().left, top: f.y + f.h + 35 - c.offset().top, zIndex: 100}), B.bind("mousedown", l)
    }

    var n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C = this, D = d, E = e, F = this.state = {angle: f || 0, deltaAngle: null, origin: null, initRelativeOrigin: {}, curtRelativeOrigin: null}, G = parseFloat(a.xgridline.css("left")), H = parseFloat(a.ygridline.css("top")), I = !1, J = 0, K = !1, L = 0;
    this.initTransform = function () {
        i(), m(), a.checkPrintableAlarm(), $(".handle-top, .handle-bottom", b).bind("mousedown", function (a) {
            a.stopPropagation(), n = !0, s = a.pageX, t = a.pageY, u = b.offset().left, v = b.offset().top, w = getMatrix(b, "x"), x = getMatrix(b, "y"), y = b.width(), z = b.height(), A = calcDistanceBetweenTwoPoints({x: F.origin.x + c.offset().left, y: F.origin.y + c.offset().top}, {x: s, y: t}), $(document).bind("mousemove", j)
        }), $(".handle-left, .handle-right", b).bind("mousedown", function (a) {
            a.stopPropagation(), o = !0, s = a.pageX, t = a.pageY, u = b.offset().left, v = b.offset().top, w = getMatrix(b, "x"), x = getMatrix(b, "y"), y = b.width(), z = b.height(), A = calcDistanceBetweenTwoPoints({x: F.origin.x + c.offset().left, y: F.origin.y + c.offset().top}, {x: s, y: t}), $(document).bind("mousemove", j)
        }), $(b).bind("mousedown", function (c) {
            c.stopPropagation(), p = !0, s = c.pageX, t = c.pageY, G = parseFloat(a.xgridline.css("left")), H = parseFloat(a.ygridline.css("top")), $(".edit-box").addClass("hidden"), b.removeClass("hidden"), m(), a.isAutoAlign && (a.xgridline.css({opacity: 1}), a.ygridline.css({opacity: 1})), a.moveToTop(C), eventManager.trigger("selectedBox", C.elem), $(document).bind("mousemove", j)
        }), $(".handle-rotate", b).bind("mousedown", function (a) {
            a.stopPropagation(), q = !0, $(document).bind("mousemove", j)
        }), $(".handle-scale", b).bind("mousedown", function (a) {
            a.stopPropagation(), r = !0, s = a.pageX, t = a.pageY, u = b.offset().left, v = b.offset().top, w = getMatrix(b, "x"), x = getMatrix(b, "y"), y = b.width(), z = b.height(), A = calcDistanceBetweenTwoPoints({x: F.origin.x + c.offset().left, y: F.origin.y + c.offset().top}, {x: s, y: t}), $(document).bind("mousemove", j)
        }), $(".handle-delete", b).bind("mousedown", function (a) {
            a.stopPropagation(), b.remove(), B.remove(), eventManager.trigger("deletedBox", C.elem), eventManager.trigger("unselectBox")
        }), $(document).bind("mouseup", function () {
            o = !1, n = !1, p = !1, q = !1, r = !1, a.xgridline.css({opacity: 0}), a.ygridline.css({opacity: 0}), $(document).unbind("mousemove", j)
        })
    };
    var M = function () {
    };
    this.onTransform = function (a) {
        M = a
    }, this.initTransform()
}
function ElementBox(a, b, c, d, e, f, g, h, i) {
    function j() {
        return 0 == e && 0 == f && 0 == g && 1 == h && 1 == i ? !0 : !1
    }

    function k() {
        var a = o.offset().left, b = o.offset().top, e = o.width(), f = o.height(), g = a + (e - c) / 2 - n.offset().left + 2, h = b + (f - d) / 2 - n.offset().top + 2;
        return{x: g, y: h}
    }

    this.elem = b;
    var l, m, n = a.htmlSurface, o = a.printable;
    this.init = function () {
        var o = "";
        o += '<div class="edit-box marching-ants marching">', o += '<div class="handle handle-drag"></div>', o += '<div class="handle handle-rotate"></div>', o += '<div class="handle handle-scale"></div>', o += '<div class="handle handle-delete"></div>', o += '<div class="handle handle-noimage handle-top"></div>', o += '<div class="handle handle-noimage handle-left"></div>', o += '<div class="handle handle-noimage handle-bottom"></div>', o += '<div class="handle handle-noimage handle-right"></div>', o += "</div>", this.object = l = $(o), n.append(l);
        var p = k();
        setMatrix(l, 1, 0, p.x, p.y), m = getMatrix(l), l.attr("data-id", b.dataId), l.css({width: c, height: d, zIndex: 0}), j() || (this.translate(e, f), this.rotate(g), this.scale(h, i)), Transform.call(this, a, l, n, c, d, g)
    }, this.translate = function (a, b) {
        var c = getMatrix(l);
        setMatrix(l, null, null, c.e + a, c.f + b)
    }, this.rotate = function (a) {
        var b = Math.cos(a * Math.PI / 180).toFixed(4), c = Math.sin(a * Math.PI / 180).toFixed(4);
        setMatrix(l, b, c, null, null)
    }, this.scale = function () {
        var a = c * h, b = d * i, e = (c - a) / 2, f = (d - b) / 2;
        this.translate(e, f), l.css({width: a, height: b})
    }, this.getMatrix = function () {
        return getMatrix(l)
    }, this.getOriginMatrix = function () {
        return m
    }, this.remove = function () {
        l.remove(), this.sizer.remove()
    }, this.init()
}
...
function Canvas(a, b) {
    function c() {
        var b = "";
        b += '<div class="new-editor" data-side="' + f.id + '">', b += '<div class="product-color"></div>', b += '<svg class="svg-surface"></svg>', b += '<img class="ghost-image" src="' + f.image + '">', b += '<div class="html-surface">', b += '<div class="printable-area-box">', b += '<div class="printable-area-toolbar">', b += "<span>设计区域</span>", b += '<div class="printable-area-zoom">', b += '<img class="printable-area-zoom-image no-select" src="ds/svg/zoom_in_light.svg">', b += '<img class="printable-area-zoom-image no-select" src="ds/svg/zoom_out_light.svg">', b += '<img class="printable-area-zoom-image zero-opacity no-select" src="ds/svg/zoom_in.svg">', b += '<img class="printable-area-zoom-image zero-opacity no-select" src="ds/svg/zoom_out.svg">', b += "</div>", b += "</div>", b += "</div>", b += '<div class="xgridline"></div>', b += '<div class="ygridline"></div>', b += "</div>", b += "</div>", d = $(b), a.append(d), d.css({width: f.width, height: f.height}), $(".product-color, .svg-surface, .html-surface", d).css({width: f.width, height: f.height}), $(".printable-area-box", d).css({left: f.printable.x, top: f.printable.y, width: f.printable.width, height: f.printable.height, borderColor: "rgba(0, 0, 0, 0.298039)"}), $(".printable-area-box>printable-area-toolbar", d).css({backgroundColor: "rgba(0, 0, 0, 0.298039)"}), e.xgridline = $(".xgridline", d).css("left", f.printable.x + f.printable.width / 2), e.ygridline = $(".ygridline", d).css("top", f.printable.y + f.printable.height / 2), e.svgSurface = $(".svg-surface", d), e.htmlSurface = $(".html-surface", d), e.printable = $(".printable-area-box", d), $(d).bind("mousedown", function () {
            $(".edit-box", d).addClass("hidden"), $(".edit-box-sizer", d).remove(), g = null, eventManager.trigger("unselectBox")
        }), e.paper = Snap(e.svgSurface[0]), e.rootG = e.paper.g()
    }

    var d, e = this, f = this.opt = {id: b.id || "side-" + (new Date).getTime(), width: b.width || 530, height: b.height || 630, image: b.image, scale: b.scale || 7.47, printable: {x: b.printable.x || 152, y: b.printable.y || 100, width: b.printable.width || 215, height: b.printable.height || 300}}, a = $(a);
    this.id = b.id || "ds_canvas_" + (new Date).getTime(), this.isAutoAlign = !0, this.lineHeight = 1, this.fontFamily = "Helvetica", this.fontSize = 48, this.fill = "#000000", this.stroke = "#000000", this.strokeWidth = 0, this.elements = [];
    var g = null;
    this.setActiveEl = function (a) {
        g = a
    }, this.text = function (a) {
        if (g && g instanceof TextElementEl)g.setText(a); else {
            var b = new TextElementEl(this, [a], this.lineHeight, this.fontFamily, this.fontSize, this.fill, this.stroke, this.strokeWidth);
            this.elements.push(b), $(".edit-box", d).addClass("hidden"), $(".edit-box[data-id=" + b.dataId + "]", d).removeClass("hidden"), g = b, this.moveToTop()
        }
    }, this.textFontFamily = function (a) {
        this.fontFamily = a, g && g instanceof TextElementEl && g.setFontFamily(a)
    }, this.textFill = function (a) {
        this.fill = a, g && g instanceof TextElementEl && g.setFill(a)
    }, this.textStroke = function (a) {
        this.stroke = a, g && g instanceof TextElementEl && g.setStroke(a)
    }, this.textStrokeWidth = function (a) {
        this.strokeWidth = a, g && g instanceof TextElementEl && g.setStrokeWidth(a)
    }, this.image = function (a) {
        var b = new BitmapElementEl(this, a);
        b.onload(function () {
            e.elements.push(b), $(".edit-box", d).addClass("hidden"), $(".edit-box[data-id=" + b.dataId + "]", d).removeClass("hidden"), g = b, e.moveToTop()
        })
    }, this.autoAlign = function (a) {
        this.isAutoAlign = a
    }, this.moveToTop = function (a) {
        a = a || g.box, $(".edit-box", d).css({zIndex: 0}), $(a.object).css({zIndex: 1});
        var b, c = this.rootG.selectAll("g");
        if (c.forEach(function (a, d) {
            d == c.length - 1 && (b = a)
        }), b) {
            var e = $(a.object).attr("data-id"), f = this.rootG.select("[data-id=" + e + "]");
            b != f && b.after(f)
        }
    }, this.moveToBottom = function () {
        if (g) {
            var a, b = this.rootG.selectAll("g");
            if (b.forEach(function (b, c) {
                0 == c && (a = b)
            }), a) {
                var c = this.rootG.select("[data-id=" + g.dataId + "]");
                if (a != c) {
                    var e = a.attr("data-id");
                    $("div.edit-box[data-id=" + e + "]", d).css("z-index", 1), $("div.edit-box[data-id=" + g.dataId + "]", d).css("z-index", 0), a.before(c), $(".edit-box[data-id=" + g.dataId + "]", d).addClass("hidden")
                }
            }
        }
    }, this.alignToCenter = function () {
        ...
        g && (g instanceof TextElementEl ? g = new TextElementEl(this, g.string, g.lineHeight, g.fontFamily, g.fontSize, g.fill, g.stroke, g.strokeWidth, g.translateX + 25, g.translateY + 25, g.angle, g.scaleX, g.scaleY, g.flipX, g.flipY) : g instanceof BitmapElementEl && (g = new BitmapElementEl(this, g.url, g.translateX + 25, g.translateY + 25, g.angle, g.scaleX, g.scaleY, g.flipX, g.flipY)), $(".edit-box", d).addClass("hidden"), $(".edit-box[data-id=" + g.dataId + "]", d).removeClass("hidden"))
    }, this.setProductImage = function (a) {
        $(".ghost-image", d).attr("src", a)
    }, this.setPrintable = function () {
        $(".printable-area-box", d).css({left: f.printable.x, top: f.printable.y, width: f.printable.width, height: f.printable.height}), $(".xgridline", d).css("left", f.printable.x + f.printable.width / 2), $(".ygridline", d).css("top", f.printable.y + f.printable.height / 2), setTimeout(function () {
            e.checkPrintableAlarm()
        }, 500)
    }, this.checkPrintableAlarm = function () {
        var a = $(".printable-area-box", d), b = $(".svg-surface", d).find("g:eq(0)"), c = !1;
        0 == b.children().length ? c = !0 : b.offset().left > a.offset().left && b.offset().left + b[0].getBBox().width < a.offset().left + a.outerWidth() && b.offset().top > a.offset().top && b.offset().top + b[0].getBBox().height < a.offset().top + a.outerHeight() && (c = !0), c ? a.removeClass("alarm") : a.addClass("alarm")
    }, this.productColor = function (a) {
        $(".product-color", d).css({background: a}), "#FFFFFF" == a.toUpperCase() ? ($(".printable-area-box", d).css({borderColor: "rgba(0, 0, 0, 0.298039)"}), $(".printable-area-box>.printable-area-toolbar", d).css({backgroundColor: "rgba(0, 0, 0, 0.298039)", color: "rgb(255, 255, 255)"}), $(".printable-area-zoom-image:eq(0), .printable-area-zoom-image:eq(1)", d).removeClass("zero-opacity"), $(".printable-area-zoom-image:eq(2), .printable-area-zoom-image:eq(3)", d).removeClass("zero-opacity").addClass("zero-opacity")) : ($(".printable-area-box", d).css({borderColor: "rgba(255, 255, 255, 0.298039)"}), $(".printable-area-box>.printable-area-toolbar", d).css({backgroundColor: "rgba(255, 255, 255, 0.298039)", color: "rgb(0, 0, 0)"}), $(".printable-area-zoom-image:eq(0), .printable-area-zoom-image:eq(1)", d).removeClass("zero-opacity").addClass("zero-opacity"), $(".printable-area-zoom-image:eq(2), .printable-area-zoom-image:eq(3)", d).removeClass("zero-opacity"))
    }, this.enabled = function () {
        d.show()
    }, this.disabled = function () {
        d.hide(), g = null, $(".edit-box", d).removeClass("hidden").addClass("hidden"), $(".edit-box-sizer", d).remove(), eventManager.trigger("unselectBox")
    }, this.load = function (a) {
        f = this.opt = {width: a.width || 530, height: a.height || 630, image: a.image, scale: a.scale || 7.47, printable: {x: a.printable.x || 152, y: a.printable.y || 100, width: a.printable.width || 215, height: a.printable.height || 300}}, $(".ghost-image", d).attr("src", f.image), this.setPrintable()
    }, c(), eventManager.on("selectedBox", function (a) {
        g = a
    }), eventManager.on("deletedBox", function (a) {
        g = null;
        for (var b, c = 0; c < e.elements.length; c++) {
            var d = e.elements[c];
            if (d == a) {
                b = c;
                break
        ...
        e.elements.splice(b, 1)
    })
}
function setMatrix(a, b, c, d, e) {
    var f, g, h, i, j, k, l = $(a).css("transform");
    if ("none" == l)f = b, g = c, h = -c, i = b, j = d, k = e; else {
        var m = l.substr(7, l.length - 7 - 1).split(",");
        f = b || m[0], g = c || m[1], h = -c || m[2], i = b || m[3], j = d || m[4], k = e || m[5]
    }
    a.css({"-o-transform": " matrix(" + f + ", " + g + ", " + h + ", " + i + ", " + j + ", " + k + ")", "-ms-transform": " matrix(" + f + ", " + g + ", " + h + ", " + i + ", " + j + ", " + k + ")", "-moz-transform": " matrix(" + f + ", " + g + ", " + h + ", " + i + ", " + j + ", " + k + ")", "-webkit-transform": " matrix(" + f + ", " + g + ", " + h + ", " + i + ", " + j + ", " + k + ")", transform: " matrix(" + f + ", " + g + ", " + h + ", " + i + ", " + j + ", " + k + ")"})
}
function getMatrix(a, b) {
    var c, d = $(a).css("transform"), e = d.substr(7, d.length - 7 - 1).split(","), f = parseFloat(e[0].trim()), g = parseFloat(e[1].trim()), h = parseFloat(e[2].trim()), i = parseFloat(e[3].trim()), j = parseFloat(e[4].trim()), k = parseFloat(e[5].trim());
    switch (b) {
        case"cos":
            c = f;
            break;
...
function Ds(a, b) {
    ...
    this.add = function (a) {
        ...
        if (this.activeCanvas.hasOwnProperty(a)) {
            for (var b = [], c = 0; c < arguments.length; c++)0 != c && b.push(arguments[c]);
            if ("productColor" == a)for (var e in d) {
                var f = d[e];
                f[a].apply(this.activeCanvas, b)
            } else this.activeCanvas[a].apply(this.activeCanvas, b)
        } else console.log("canvas not found method:", a)
    };
    var e = [];
    b instanceof Array ? e = b : b instanceof Object && (e = [b]);
    for (var f = 0; f < e.length; f++) {
        var g = e[f], h = new Canvas(a, g);
        d.push(h), 0 == f && this.active(h)
    }
    this.autoAlign = function (a) {
        for (var b = 0; b < d.length; b++) {
            var c = d[b];
            c.autoAlign.call(c, a)
        }
    }, this.load = function (a) {
        for (var b in a) {
            var d = a[b], e = c(d.id);
...
!function (a, b) {
    fontSpy = function (a, c) {
        ...
        var g = {font: f, fontClass: f.toLowerCase().replace(/\s/g, ""), success: function () {
        }, failure: function () {
        }, testFont: "Courier New", testString: "QW@HhsXJ", glyphs: "", delay: 50, timeOut: 1e3, callback: b.noop}, h = b.extend(g, c), i = b("<span>" + h.testString + h.glyphs + "</span>").css("position", "absolute").css("top", "-9999px").css("left", "-9999px").css("visibility", "hidden").css("fontFamily", h.testFont).css("fontSize", "250px");
        e.append(i);
        var j = i.outerWidth();
    ...
    var c = function (b) {
        ...
        function s(a) {
            ...
            if (this.anims = {}, this._ = {transform: []}, a.snap = d, V[d] = this, "g" == this.type && (this.add = r), this.type in{g: 1, mask: 1, pattern: 1, symbol: 1})for (var e in v.prototype)v.prototype[z](e) && (this[e] = v.prototype[e])
        }
        ...
        c._.glob = y;
        var z = "hasOwnProperty", A = String, B = parseFloat, C = parseInt, D = Math, E = D.max, F = D.min, G = D.abs, H = (D.pow, D.PI), I = (D.round, ""), J = Object.prototype.toString, K = /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?%?)\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?%?)\s*\))\s*$/i, L = (c._.separator = /[,\s]+/, /[\s]*,[\s]*/), M = {hs: 1, rg: 1}, N = /([a-z])[\s,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\s]*,?[\s]*)+)/gi, O = /([rstm])[\s,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\s]*,?[\s]*)+)/gi, P = /(-?\d*\.?\d*(?:e[\-+]?\\d+)?)[\s]*,?[\s]*/gi, Q = 0, R = "S" + (+new Date).toString(36), S = function (a) {
        ...
        c.url = function (a) {
            ...
            return j ? (j[2] && (f = C(j[2].substring(5), 16), d = C(j[2].substring(3, 5), 16), b = C(j[2].substring(1, 3), 16)), j[3] && (f = C((h = j[3].charAt(3)) + h, 16), d = C((h = j[3].charAt(2)) + h, 16), b = C((h = j[3].charAt(1)) + h, 16)), j[4] && (i = j[4].split(L), b = B(i[0]), "%" == i[0].slice(-1) && (b *= 2.55), d = B(i[1]), "%" == i[1].slice(-1) && (d *= 2.55), f = B(i[2]), "%" == i[2].slice(-1) && (f *= 2.55), "rgba" == j[1].toLowerCase().slice(0, 4) && (g = B(i[3])), i[3] && "%" == i[3].slice(-1) && (g /= 100)), j[5] ? (i = j[5].split(L), b = B(i[0]), "%" == i[0].slice(-1) && (b /= 100), d = B(i[1]), "%" == i[1].slice(-1) && (d /= 100), f = B(i[2]), "%" == i[2].slice(-1) && (f /= 100), ("deg" == i[0].slice(-3) || "°" == i[0].slice(-1)) && (b /= 360), "hsba" == j[1].toLowerCase().slice(0, 4) && (g = B(i[3])), i[3] && "%" == i[3].slice(-1) && (g /= 100), c.hsb2rgb(b, d, f, g)) : j[6] ? (i = j[6].split(L), b = B(i[0]), "%" == i[0].slice(-1) && (b /= 100), d = B(i[1]), "%" == i[1].slice(-1) && (d /= 100), f = B(i[2]), "%" == i[2].slice(-1) && (f /= 100), ("deg" == i[0].slice(-3) || "°" == i[0].slice(-1)) && (b /= 360), "hsla" == j[1].toLowerCase().slice(0, 4) && (g = B(i[3])), i[3] && "%" == i[3].slice(-1) && (g /= 100), c.hsl2rgb(b, d, f, g)) : (b = F(D.round(b), 255), d = F(D.round(d), 255), f = F(D.round(f), 255), g = F(E(g, 0), 1), j = {r: b, g: d, b: f, toString: Z}, j.hex = "#" + (16777216 | f | d << 8 | b << 16).toString(16).slice(1), j.opacity = e(g, "finite") ? g : 1, j)) : {r: -1, g: -1, b: -1, hex: "none", error: 1, toString: Z}
        ...
        c.color = function (a) {
            ...
            var d, e, f, g;
            return f = E(a, b, c), g = f - F(a, b, c), d = 0 == g ? null : f == a ? (b - c) / g : f == b ? (c - a) / g + 2 : (a - b) / g + 4, d = (d + 360) % 6 * 60 / 360, e = 0 == g ? 0 : g / f, {h: d, s: e, b: f, toString: X}
        }, c.rgb2hsl = function (a, b, c) {
            c = $(a, b, c), a = c[0], b = c[1], c = c[2];
            var d, e, f, g, h, i;
            return g = E(a, b, c), h = F(a, b, c), i = g - h, d = 0 == i ? null : g == a ? (b - c) / i : g == b ? (c - a) / i + 2 : (a - b) / i + 4, d = (d + 360) % 6 * 60 / 360, f = (g + h) / 2, e = 0 == i ? 0 : .5 > f ? i / (2 * f) : i / (2 - 2 * f), {h: d, s: e, l: f, toString: Y}
    ...
    return d.plugin(function (d, e, f, g, h) {
        ...
        m.transform = function (a) {
            ...
            return null == a && (a = this.getBBox()), n(a, "object") && "x"in a && (b = a.y, c = a.width, d = a.height, a = a.x), q(e.node, {x: a, y: b, width: c, height: d, patternUnits: "userSpaceOnUse", id: e.id, viewBox: [a, b, c, d].join(" ")}), e.node.appendChild(this.node), e
        }, m.marker = function (a, b, c, d, e, f) {
            var g = r("marker", s(this));
            return null == a && (a = this.getBBox()), n(a, "object") && "x"in a && (b = a.y, c = a.width, d = a.height, e = a.refX || a.cx, f = a.refY || a.cy, a = a.x), q(g.node, {viewBox: [a, b, c, d].join(" "), markerWidth: c, markerHeight: d, orient: "auto", refX: e || 0, refY: f || 0, id: g.id}), g.node.appendChild(this.node), g
        };
        ...
        d._.Animation = w, d.animation = function (a, b, c, d) {
            ...
            for (var c in a.anims)a.anims[t](c) && !function (a) {
                b.push({anim: new w(a._attrs, a.dur, a.easing, a._callback), mina: a, curStatus: a.status(), status: function (b) {
                    return a.status(b)
                }, stop: function () {
                    a.stop()
                }})
        ...
        m.data = function (a, c) {
            ...
            if (a && a.btoa) {
                var b = this.getBBox(), c = d.format('<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="{width}" height="{height}" viewBox="{x} {y} {width} {height}">{contents}</svg>', {x: +b.x.toFixed(3), y: +b.y.toFixed(3), width: +b.width.toFixed(3), height: +b.height.toFixed(3), contents: this.outerSVG()});
        ...
        function x(a, b, c, d, f) {
            if (null == f && null == d && (d = c), a = +a, b = +b, c = +c, d = +d, null != f)var g = Math.PI / 180, h = a + c * Math.cos(-d * g), i = a + c * Math.cos(-f * g), j = b + c * Math.sin(-d * g), k = b + c * Math.sin(-f * g), l = [
                ["M", h, j],
        ...
        function D(a, b, c, d, e, f, g, h) {
            for (var i, j, k, l, m, n, o, p, q = [], r = [
                [],
                []
            ], s = 0; 2 > s; ++s)if (0 == s ? (j = 6 * a - 12 * c + 6 * e, i = -3 * a + 9 * c - 9 * e + 3 * g, k = 3 * c - 3 * a) : (j = 6 * b - 12 * d + 6 * f, i = -3 * b + 9 * d - 9 * f + 3 * h, k = 3 * d - 3 * b), S(i) < 1e-12) {
        ...
        var H = b.prototype, I = a.is, J = a._.clone, K = "hasOwnProperty", L = /,?([a-z]),?/gi, M = parseFloat, N = Math, O = N.PI, P = N.min, Q = N.max, R = N.pow, S = N.abs, T = h(1), U = h(), V = h(0, 1), W = a._unit2px, X = {path: function (a) {
            return a.attr("path")
        }, circle: function (a) {
            var b = W(a);
        ...
        n.stroke = n.fill = "colour", c.prototype.equal = function (a, c) {
            ...
            if ("points" == b)return d = p(r).split(a._.separator), q = p(c).split(a._.separator), {from: d, to: q, f: function (a) {
                return a
            }};
        ...
        for (var f = c.prototype, g = "hasOwnProperty", h = ("createTouch"in e.doc), i = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "touchstart", "touchmove", "touchend", "touchcancel"], j = {mousedown: "touchstart", mousemove: "touchmove", mouseup: "touchend"}, k = (function (a, b) {
            ...
            a[b] = f[b] = function (c, d) {
                if (a.is(c, "function"))this.events = this.events || [], this.events.push({name: b, f: c, unbind: n(this.node || document, b, c, d || this)}); else for (var e = 0, f = this.events.length; f > e; e++)if (this.events[e].name == b)try {
        ...
        f.drag = function (c, d, e, f, g, h) {
            function i(i, j, l) {
                (i.originalEvent || i).preventDefault(), k._drag.x = j, k._drag.y = l, k._drag.id = i.identifier, !o.length && a.mousemove(p).mouseup(q), o.push({el: k, move_scope: f, start_scope: g, end_scope: h}), d && b.on("snap.drag.start." + k.id, d), c && b.on("snap.drag.move." + k.id, c), e && b.on("snap.drag.end." + k.id, e), b("snap.drag.start." + k.id, g || f || k, j, l, i)
            }
...
}), window.eventManager = new EventManager, TextElementEl.prototype.setText = function (a) {
    if (0 == a.length)return this.g.remove(), this.box.remove(), void this.canvas.setActiveEl(null);
    var b = $(this.snapEl.node);
    b.empty(), this.string = null == a ? [] : String(a).split(/\r?\n/);
    for (var c = [], d = 0; d < this.string.length; d++)c.push('<tspan x="0" y="0" dy="' + (this.fontSize + d * this.fontSize) + '">' + this.string[d] + "</tspan>");
    b.html(c.join(""));
    for (var e = $(this.snapEl.node)[0].offsetWidth, b = this.snapEl.node.getBBox(), d = 0; d < this.snapEl.node.childNodes.length; d++) {
        var f = this.snapEl.node.childNodes[d], g = parseInt(f.getAttribute("dy"));
        g -= b.y, f.setAttribute("dy", g);
        var h = f.getComputedTextLength(), i = (e - h) / 2;
        f.setAttribute("x", i)
    }
    this.initBox()
}, TextElementEl.prototype.setFontFamily = function (a) {
    var b = this;
    fontSpy(a, {glyphs: "", success: function () {
        b.snapEl.node.setAttribute("font-family", a);
        for (var c = 0; c < b.snapEl.node.childNodes.length; c++) {
            var d = b.snapEl.node.childNodes[c];
            d.setAttribute("dy", b.fontSize + b.fontSize * c * b.lineHeight)
        }
        for (var e = b.snapEl.node.getBBox(), f = $(b.snapEl.node)[0].offsetWidth, c = 0; c < b.snapEl.node.childNodes.length; c++) {
            var d = b.snapEl.node.childNodes[c], g = parseInt(d.getAttribute("dy"));
            g -= e.y, d.setAttribute("dy", g);
            var h = d.getComputedTextLength(), i = (f - h) / 2;
            d.setAttribute("x", i)
        }
        b.initBox()
    }})
}, TextElementEl.prototype.setFill = function (a) {
    this.snapEl.node.setAttribute("fill", a)
}, TextElementEl.prototype.setStroke = function (a) {
    this.snapEl.node.setAttribute("stroke", a)
}, TextElementEl.prototype.setStrokeWidth = function (a) {
    this.snapEl.node.setAttribute("stroke-width", a)
