...
<script type="text/javascript">
    ...
    function momey_option(obj){
        ...
        $.ajax({
            url:'/api?model=admin/user/withdrawapply&action=updateStatus',
            data:{
                id:id,
                status:status
            },
    ...
    jQuery(function ($) {
        ...
        var url_api_list = "/api?model=" + url_api_base + "&action=money_flow&uid=<?=$uid?>";
        ...
        var grid_setting = {
            ...
            cols:[
                ...
                {title:"UID",name:'uid',index:'uid',editable: false,sortable:false,width:100,
