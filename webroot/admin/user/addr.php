                                                            ...
                                                            <div class="widget-main">
                                                                <form class="form-inline">
                                                                    ...
                                                                    <select id="status">
                                                                        ...
                                                                        <option value="unread">未审核</option>
...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        var url_api_list = "/api?model=" + url_api_base + "&action=addr&uid=<?=$uid?>";
        ...
        var grid_setting = {
            ...
            cols:[
                ...
                {title:"UID",name:'uid',index:'uid',editable: false,sortable:false,width:30,
                    formatter: function (cellvalue, options, rowObject) {
                        var str = '<a href="/admin/user/modify?id='+cellvalue+'">'+cellvalue+'</a>';
                        console.log(rowObject)
                        return str;
                    },},
                {title:"手机",name:'tel',index:'tel',editable: false,sortable:false,width:70},
                {title:"省",name:'province',index:'province',editable: false,sortable:false,width:50},
                {title:"市",name:'city',index:'city',editable: false,sortable:false,width:50},
                {title:"区",name:'county',index:'county',editable: false,sortable:false,width:50},
                {title:"详细地址",name:'addr',index:'addr',editable: false,sortable:false, width: 100},
                {title:"姓名",name:'name',index:'name',editable: false,sortable:false,width:50},
                {title: "操作", name: 'status', index: '', width: 100, fixed: true, sortable: false, resize: false,
                    formatter: function (cellvalue, options, rowObject) {
                    if (cellvalue == 0) {
                        return '<a class="btn btn-xs btn-success audit" href="#" onclick="audit(this)" ' +
                            'data-toggle="modal" data-target=".bs-example-modal-sm-1" data-id="' + rowObject['id'] + '">详情</a>';
                    }else{
                        return '';
                    }
                }
