                                                            ...
                                                            <div class="widget-main">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xs-2">
                                                                        ...
                                                                        <button class="btn-danger label-success"
                                                                                onclick="reset()">重置
                                                                        </button>
                                                                    </div>
                                                                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-sm apply-back" data-dismiss="modal"><i
...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        var url_api_list = "/api?model=" + usl_api_base + "&action=list&pass=1";
