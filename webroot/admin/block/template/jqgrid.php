...
<script type="text/javascript">
    ...
    jQuery(function($) {
        var grid_setting = {
            ...
            caption:"",
            cols:[
                {title:"操作",name:'myac',index:'', width:80, fixed:true, sortable:false, resize:false,
                    formatter:'actions',
                    formatoptions:{
                        keys:true,
                ...
                {title:"last_login_time",name:'last_login_time',index:'nlast_login_timeame',editable: true,editoptions:{size:"20",maxlength:"30"}},
            ]
