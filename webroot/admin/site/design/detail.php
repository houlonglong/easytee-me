            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div>
                            <?php
                            echo Model_Design::reset_svg($design_svgs['svg_front']);
                            ?>
                            <hr>
                            <?php
                            echo Model_Design::reset_svg($design_svgs['svg_back']);
                            ?> <hr>
                            <?php
                            echo Model_Design::reset_svg($design_svgs['svg_third']);
                            ?> <hr>
                            <?php
                            echo Model_Design::reset_svg($design_svgs['svg_fourth']);
                            ?>
                        </div>
