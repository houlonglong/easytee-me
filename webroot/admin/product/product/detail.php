...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        var url_api_base   = "admin/product/style";
        var url_api_list   = "/api?model="+url_api_base + "&action=list&product_id="+product_id;
        ...
        var grid_setting = {
            ...
            cols:[
                ...
                {title:"product_id",name:'product_id',index:'product_id',editable: false,sortable:true},
                {title:"style_id",name:'product_style_id',index:'product_style_id',editable: false,sortable:true},
                {title:"size",name:'size',index:'size',editable: false,sortable:true},
                {title:"库存",name:'inventory',index:'inventory', editable: false,sortable:false},
                {title:"默认款式",name:'is_default',index:'is_default',editable: false,sortable:false},
                {title:"colors",name:'colors',index:'colors',editable: false,sortable:false},
                {title:"color_name",name:'color_name',index:'color_name',editable: false,sortable:false},
                {title:"purchase_price",name:'purchase_price',index:'purchase_price',editable: false,sortable:false},
                {title:"selling_price",name:'selling_price',index:'selling_price',editable: false,sortable:false},
                /*
