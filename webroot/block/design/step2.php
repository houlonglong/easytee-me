    ...
    <div class="ds-pricing-row dotted-top-line">
        ...
        <div class="ds-pricing-product-add">
            <div class="ds-pricing-product-add-icon">
                添加其他款式
                <div class="ds-pricing-product-add-icon-begin"></div>
                <div class="ds-pricing-product-add-icon-end"></div>
            </div>
            <div class="ds-pricing-product-add-total">还可以添加 <span>9</span> 种商品</div>
            ...
            <div class="ds-pricing-product-add-desc">
                添加更多的品类，让你的产品选择更加丰富
            </div>
        </div>
    </div>
